...
import {Contextable} from "@src/core/injection/Contextable";
import {Injectable} from "@src/core/injection/Injectable";
...
export class GlobalContextService implements Contextable {
    ...
    static readonly GLOBAL_CONTEXTS_ID = '__Aware_a_GlobalContextStore';
